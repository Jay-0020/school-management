...
const MODULES: Record<string, { label: string; roles: Role[]; path?: string }> = {
  ...
  payroll: { label: "Payroll", roles: ["SUPER_ADMIN", "ADMIN", "ACCOUNTANT", "TEACHER"], path: "/payroll" },
  expenses: { label: "Expense Approvals", roles: ["SUPER_ADMIN", "ADMIN", "TEACHER", "ACCOUNTANT"], path: "/expenses" },
